          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <nav className="hidden sm:ml-6 sm:flex sm:space-x-6 items-center">
                ...
                <Link
                  href="/resources"
                  className="inline-flex items-center space-x-1 px-3 py-1.5 rounded-lg border-2 border-blue-500 text-blue-600 bg-white hover:bg-blue-50 hover:text-blue-700 transition-colors text-lg font-medium"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
